...
(function () {
  ...
  function loadCampaignScope(caseId) {
    ...
    fetch(`/cases/${encodeURIComponent(caseId)}/campaign-scope`)
      .then((r) => (r.ok ? r.json() : { messages: [], messagesNotRead: 0, generated: "" }))
      .then((d) => {
