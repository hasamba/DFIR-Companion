...
import { partitionByToolAvailability, type UnavailableArtifact } from "./artifactTools.js";
...
export async function preflightBundleArtifacts(
  ...
  const { runnable, unavailable } = partitionByToolAvailability(present, definitions);
