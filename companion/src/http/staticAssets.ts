...
export const STATIC_ASSETS: Record<string, string> = {
  ...
  // The Timeline Swimlane canvas chart (#415 tier 3). Its entry point is guarded, so a 404 here
  // costs the chart and nothing else — but the guard is the only reason that is true.
