...
const UNTRUSTED_SPAN_RE =
  /\[(?:trailer|query|returned|the record also carries returned values|sni|cert|client cert|certificate|agent|data url|origin|sender|quarantine mark|event identifier not decodable): [^\]]*\]/g;
