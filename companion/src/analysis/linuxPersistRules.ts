...
const TRANSIENT_RE = /^\/(?:tmp|var\/tmp|dev\/shm|run\/shm|var\/lock)(?:\/|$)/;

/** Directories a standard install puts SUID binaries in. */
const STANDARD_BIN_RE = /^\/(?:usr\/(?:bin|sbin|lib|lib64|libexec|local\/(?:bin|sbin))|bin|sbin|opt)\//;
