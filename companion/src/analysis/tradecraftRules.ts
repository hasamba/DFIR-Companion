...
export const TRADECRAFT_RULES: TradecraftRule[] = [
  ...
  {
    re: /\bset-mppreference\b[^\n]*-disable(?:realtimemonitoring|behaviormonitoring|scriptscanning|ioavprotection|blockatfirstseen|archivescanning)/i,
    weight: "strong",
    ids: ["T1562.001"],
  },
  {
    re: /\bset-mppreference\b[^\n]*(?:-mapsreporting\s+0|-submitsamplesconsent\s+[2-4]|-severethreatdefaultaction)/i,
    weight: "strong",
    ids: ["T1562.001"],
  },
  {
    re: /\badd-mppreference\b[^\n]*-exclusion(?:path|process|extension)/i,
    weight: "strong",
    ids: ["T1562.001"],
  },
  {
  ...
  {
    re: /\b(?:net|net1|sc)(?:\.exe)?\b[^\n]*\b(?:stop|config|delete|disabled)\b[^\n]*\b(?:windefend|wdnissvc|wdfilter|wdboot|sense|securityhealthservice|wscsvc|mpssvc)\b/i,
    weight: "strong",
    ids: ["T1562.001"],
  },
  {
  ...
  {
    re: /\bdefender\s*control\b|\bdefendercontrol\b|\bdis_defender\b|\bdefendermalwar/i,
    weight: "strong",
    ids: ["T1562.001"],
  },
  ...
  {
    re: /\b(?:rwdrv|hlpdrv|winring0x?64|aswarpot|truesight|kArtos|gdrv|dbutil_?2_?3|msio64|procexp1?[56]?\d?)\.sys\b/i,
    weight: "strong",
    ids: ["T1562.001"],
  },
  ...
  {
    re: /\b(?:nxc|netexec|crackmapexec|cme)\b[^\n]*(?:--ntds|-m\s+lsassy|--sam|--lsa|--dpapi)/i,
    weight: "strong",
    ids: ["T1003"],
  },
  {
    re: /\besentutl(?:\.exe)?\b[^\n]*(?:\/vss|\/y)[^\n]*ntds|\bntdsutil\b[^\n]*\bac\s+i(?:n)?\s+ntds\b/i,
    weight: "strong",
    ids: ["T1003.003"],
  },
  // SAM is already covered by isSuspiciousCmd; the SECURITY/SYSTEM hive companions are not.
  {
    re: /\breg(?:\.exe)?\b[^\n]*\bsave\b[^\n]*hk(?:lm|ey_local_machine)\\?(?:security|system)\b/i,
    weight: "strong",
    ids: ["T1003.002"],
  },
  {
    re: /\b(?:lazagne|donpapi|invoke-powerdump|invoke-sessiongopher|credentialsfileview|webbrowserpassview|chromepass|vncpassview|mailpv|netpass|wirelesskeyview|passrecenc|ntdsaudit)\b/i,
    weight: "strong",
    ids: ["T1555"],
  },
  {
    re: /\b(?:rubeus|orpheus)\b|\bget-?userspns(?:\.py)?\b|\binvoke-kerberoast\b/i,
    weight: "strong",
    ids: ["T1558.003"],
  },
  ...
  {
    re: /\b(?:copy|xcopy|robocopy)\b[^\n]*\\(?:login data|cookies|web data)\b/i,
    weight: "strong",
    ids: ["T1555.003"],
  },
  ...
  {
    re: /\bwmic(?:\.exe)?\b[^\n]*shadowcopy\s+delete|win32_shadowcopy[^\n]*(?:remove-wmiobject|remove-ciminstance|delete)/i,
    weight: "strong",
    ids: ["T1490"],
  },
  {
    re: /\bbcdedit(?:\.exe)?\b[^\n]*(?:recoveryenabled\s+no|bootstatuspolicy\s+ignoreallfailures)/i,
    weight: "strong",
    ids: ["T1490"],
  },
  {
    re: /\bwbadmin(?:\.exe)?\b[^\n]*delete\s+(?:catalog|systemstatebackup)|\bvssadmin\b[^\n]*resize\s+shadowstorage/i,
    weight: "strong",
    ids: ["T1490"],
  },
  ...
  {
    re: /--enc(?:rypt)?\b[^\n]*\s--?path\b|--?path\b[^\n]*\s--enc(?:rypt)?\b|\s-p=\S+\s+-n=\d|\s-n=\d+\s+netonly\b|\s-dellog\b/i,
    weight: "strong",
    ids: ["T1486"],
  },
  ...
  {
    re: /\b(?:net|net1)\s+stop\b[^\n]*\b(?:veeam|sqlserveragent|mssql|msexchange|backupexec|acronis|sophos)/i,
    weight: "weak",
    ids: ["T1489"],
  },
  {
    re: /\btaskkill\b[^\n]*\/im\b[^\n]*\b(?:veeam|sqlservr|sqlagent|sqlwriter|msexchange)/i,
    weight: "weak",
    ids: ["T1489"],
  },
  ...
  {
    re: /\bngrok\b|\bcloudflared\b|\bfrpc?\b(?:\.exe|\.ini)?|\bpowercat\b|\bproxychains\b|\bgost(?:\.exe)?\b/i,
    weight: "weak",
    ids: ["T1572"],
  },
  ...
  {
    re: /\bwebhook\.site\b|\boastify\.com\b|\bburpcollaborator\.net\b|\boast\.(?:fun|live|online|pro|site)\b|\binteract\.sh\b/i,
    weight: "weak",
    ids: ["T1071.001"],
  },
  ...
  {
    re: /\brouter\.bittorrent\.com\b|\brouter\.utorrent\.com\b|\bdht\.transmissionbt\.com\b/i,
    weight: "weak",
    ids: ["T1090"],
  },
  ...
  {
    re: /\brclone(?:\.exe)?\b[^\n]*\b(?:mega|wasabi|dropbox|gdrive|drive|s3|b2|backblaze|onedrive|pcloud|ftp|sftp|swift|box|azureblob):/i,
    weight: "strong",
    ids: ["T1567.002"],
  },
  ...
  {
    re: /\b(?:winrar|rar)(?:\.exe)?\b[^\n]*\s-(?:ep1|scul|iext|imon1)\b/i,
    weight: "weak",
    ids: ["T1560.001"],
  }, // WinRAR staging fingerprint
  ...
  {
    re: /\b(?:anydesk|rustdesk)\b[^\n]*(?:--set-password|--start-with-win|--tray|--silent)/i,
    weight: "strong",
    ids: ["T1219"],
  },
  {
    re: /\b(?:anydesk|rustdesk|screenconnect|connectwise|atera|splashtop|meshagent|tacticalrmm|gotoresolve|goto\s*resolve|netsupport|client32\.ini|dwagent|remoteutilities|pulseway|action1|level\.io|supremo)/i,
    weight: "weak",
    ids: ["T1219"],
  },
  ...
  {
    re: /\bcobalt\s*strike\b|\bbrute\s*ratel\b|\bbruteratel\b|\bposh\s*c2\b|\bkoadic\b|\badaptixc2\b|\bmeterpreter\b|\bmetasploit\b|\bsliver\b|\bpeerblight\b|\bzinfoq\b|\bcowtunnel\b/i,
    weight: "weak",
    ids: ["T1071"],
  },
  {
    re: /\bcertipy\b|\bnopac\b|\bpachine\b|\bzerologon\b|\bzer0dump\b|\bsharpprintnightmare\b|\bpetitpotam\b|\bcoercer\b|\bnoPac\b/i,
    weight: "weak",
    ids: ["T1068"],
  },
  ...
  {
    re: /\bhistory\s+-c\b|\bunset\s+HISTFILE\b|HISTFILE=\/dev\/null|\bHISTSIZE=0\b/i,
    weight: "strong",
    ids: ["T1070.003"],
  },
  {
  ...
  {
    re: /\b(?:cat|less|more|head|tail|strings|nl|xxd|od)\b[^\n]*(?:\/\.env\b|[\w.-]+\.env\b|\/\.ssh\/id_(?:rsa|dsa|ecdsa|ed25519)\b|\.my\.cnf\b|\.pgpass\b|\.aws\/credentials\b|credentials\.json\b)/i,
    weight: "weak",
    ids: ["T1552.001"],
  },
...
export function tradecraftSignal(
  image: string,
  cmd: string,
