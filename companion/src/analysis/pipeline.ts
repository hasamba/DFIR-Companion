...
export const SYSTEM_PROMPT = [
  ...
  "",
  "DO NOT put the analyst's own work into the forensic timeline. EXCLUDE events that describe you",
  "operating the DFIR tooling or navigating the UI — e.g. Velociraptor hunts created/started/",
  "expired, notebooks/pages/sections 'accessed', VQL or queries or searches executed, 'EventLog",
  "analysis performed', 'Response and Monitoring accessed', VirusTotal lookups, clicking/scrolling.",
  "Those are the investigator's work log, NOT incident events — ignore them entirely. A forensic",
  "event must describe activity by the host/user/attacker recorded IN the artifact data, not the",
  "act of looking at it. If a screenshot only shows the tool being used, return no forensicEvents.",
  "",
