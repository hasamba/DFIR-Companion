...
export const SYSTEM_PROMPT = [
  ...
  "to drop a real artifact row): (1) operating the tooling / your own workflow — running a hunt or",
  "query, 'EventLog analysis performed', 'Response and Monitoring accessed', 'data collection',",
  "'analysis completed', clicking/scrolling; (2) opening or navigating to a tool/dashboard — 'Access",
  "to VolWeb', 'DFIR Companion dashboard access observed', 'Kibana opened'. The DATA inside a tool is",
  "evidence; the act of operating or opening the tool is not. NEVER stamp an event with the screenshot",
  "capture time — if a row has no time column, use \"\".",
  "",
