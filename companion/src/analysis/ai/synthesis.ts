...
async function autoGenerateHypotheses(
  ...
  // The timeline's id set is the eligibility for the material-change reading (#933 item 22): a link
  // to an event that is not there cannot make a frozen conclusion's footing change.
