...
export const GAP_HYPOTHESIS_PROMPT = [
  ...
  "  would best confirm THIS hypothesis (e.g. prefetch or process-creation logs for execution — note",
  "  that ShimCache and Amcache show a file was PRESENT and are partial by design, so their silence",
  "  does not mean a binary did not run; usn-journal/",
