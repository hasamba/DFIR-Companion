...
export const TAGGER_RULE_PROMPT = [
  ...
  "description, message, asset, path, artifactName, processName, parentName, commandLine, sha256, md5,",
  "srcIp, dstIp, veloUrl, severity, action, sources, mitreTechniques, relatedFindingIds, provenance,",
  "port, pid, count.",
  "",
