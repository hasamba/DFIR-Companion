...
export const SYNTHESIS_PROMPT = [
  ...
  "the prose alone. <sandbox:SOURCE verdict family score sig,sig> means the SAMPLE seen at this event was",
  "detonated in a lab and behaved that way THERE: it is intelligence about the file, not behaviour observed",
  "on this host. Use it to judge what the file is; never narrate a sandbox signature as something that",
  "happened on the host unless a host event shows it. When an ATTACK GRAPH, ATTACK PHASES, or PERIODIC BEACON CANDIDATES section is present,",
