...
export const SYNTHESIS_PROMPT = [
  ...
  "",
  "Produce:",
  "If the evidence shows ONLY routine, approved, or otherwise benign activity — no attacker technique,",
  "tool, or malicious behavior anywhere in the timeline — return an EMPTY findings array. Do NOT invent",
  "a low-confidence 'nothing suspicious found' or 'routine activity' finding just to have something to",
  "return; state that conclusion in 'summary' instead. This is about the ABSENCE of malicious activity",
  "in what you were shown, not about low confidence — a genuinely suspicious finding stays a finding",
  "even at low confidence; only omit findings entirely when nothing in the timeline suggests attacker",
  "activity at all. Likewise leave threadsOpened/keyQuestions/nextSteps empty when nothing is actually",
  "open or unknown, and uncertainties empty ONLY when you have no reason to doubt the sample itself; if",
  "the evidence shown is narrow or you suspect it may not be representative, say so as an uncertainty",
