...
export const SYNTHESIS_PROMPT = [
  ...
  "  when the question is fully answered. If a finding already shows file activity under a directory whose",
  "  full contents you have NOT seen (e.g. one subfolder surfaced via $MFT/Autoruns/a detection hit, but a",
  "  sibling or parent folder on that same host did not), prefer collecting/examining that sibling/parent",
  "  path on the SAME host over reaching for external logs or a different host first — it is the cheapest,",
  "  most direct source for that question.",
