...
export async function seedDemoCase(
  ...
  const superTimeline: ForensicEvent[] = [
    ...
    { id: "st007", timestamp: ts(16, 8, 22), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "DC01", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - GLOBALTECH\\jsmith - LogonType=3 - IpAddress=10.10.10.45 - WorkstationName=WKSTN-JSMITH @ DC01 [Network]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t3 Account Name: jsmith Source Network Address: 10.10.10.45" },
    ...
    { id: "st022", timestamp: ts(20, 7, 5), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "WEB01", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - GLOBALTECH\\svc-admin - LogonType=10 - IpAddress=10.10.20.15 - WorkstationName=DC01 @ WEB01 [RemoteInteractive/RDP from 10.10.20.15]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t10 Account Name: svc-admin Source Network Address: 10.10.20.15" },
    { id: "st023", timestamp: ts(20, 7, 6), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "WEB01", sources: ["EVTX"], port: 3389, description: "TerminalServices-RemoteConnectionManager operational log", message: "TerminalServices-RemoteConnectionManager 1149: RDP-Tcp session established from 10.10.20.15" },
    ...
    { id: "st027", timestamp: ts(15, 8, 5), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "WKSTN-JSMITH", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - GLOBALTECH\\jsmith - LogonType=2 @ WKSTN-JSMITH [Interactive]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t2 Account Name: jsmith — console logon at start of business day" },
    { id: "st028", timestamp: ts(16, 8, 23), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "DC01", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - NT AUTHORITY\\SYSTEM - LogonType=5 @ DC01 [Service]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t5 Account Name: SYSTEM — PSEXESVC service logon" },
    { id: "st029", timestamp: ts(16, 8, 20), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "DC01", sources: ["EVTX"], count: 214, endTimestamp: ts(16, 9, 20), description: "Windows Security Failed logon (EID 4625) - GLOBALTECH\\svc-backup - LogonType=3 - IpAddress=10.10.10.45 - WorkstationName=WKSTN-JSMITH @ DC01", message: "Security-Auditing 4625: An account failed to log on. Logon Type:\t\t3 Account Name: svc-backup Source Network Address: 10.10.10.45 — 214 failures in 1 h (SIEM alert e030)" },
    { id: "st030", timestamp: ts(16, 9, 58), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "WKSTN-JSMITH", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - GLOBALTECH\\admin-deploy - LogonType=9 @ WKSTN-JSMITH [NewCredentials]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t9 Account Name: admin-deploy — runas /netonly with the dumped domain-admin credentials ahead of the 10:00 PsExec fan-out" },
    { id: "st031", timestamp: ts(16, 10, 0), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "FS01", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - GLOBALTECH\\admin-deploy - LogonType=3 - IpAddress=10.10.10.45 - WorkstationName=WKSTN-JSMITH @ FS01 [Network]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t3 Account Name: admin-deploy Source Network Address: 10.10.10.45 — PsExec lateral movement to FS01" },
    { id: "st032", timestamp: ts(16, 10, 5), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "WEB01", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - GLOBALTECH\\admin-deploy - LogonType=3 - IpAddress=10.10.10.45 - WorkstationName=WKSTN-JSMITH @ WEB01 [Network]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t3 Account Name: admin-deploy Source Network Address: 10.10.10.45 — PsExec lateral movement to WEB01" },
    { id: "st033", timestamp: ts(16, 8, 21), severity: "Low", mitreTechniques: [], relatedFindingIds: [], sourceScreenshots: [], asset: "DC01", sources: ["EVTX"], description: "Windows Security Successful logon (EID 4624) - GLOBALTECH\\WKSTN-JSMITH$ - LogonType=3 - IpAddress=10.10.10.45 @ DC01 [Network]", message: "Security-Auditing 4624: An account was successfully logged on. Logon Type:\t\t3 Account Name: WKSTN-JSMITH$ — routine machine-account authentication" },
