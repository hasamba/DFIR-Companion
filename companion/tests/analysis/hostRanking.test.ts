...
function caseState(): ReturnType<typeof emptyState> {
  ...
  s.forensicTimeline.push(
    ev(
      ...
      "WS-DEV-01",
      "Critical",
      "2024-03-18T15:24:38Z",
      ["T1003.001"],
      "LSASS dump by wdi-svc.exe (marcus.chen)",
    ),
    ev(
      "a2",
      "WS-DEV-01",
      "High",
      "2024-03-18T14:17:07Z",
      ["T1204.002"],
      "dropper brsvc.exe by DOMAIN\\marcus.chen",
    ),
  ...
  for (let i = 0; i < 40; i++)
    s.forensicTimeline.push(ev(`n${i}`, "WS-HR-01", "Info", "2024-03-18T12:00:00Z", [], "benign telemetry"));
