...
describe("HypothesisStore", () => {
  ...
  it("applyAutoGenerated merges synthesis seeds, refreshes pristine, persists only on change", async () => {
    const seeds = [{ sourceKey: hypothesisAutoKey("Phishing"), title: "Phishing", description: "v1", expectedOutcome: "", status: "open" as const, relatedTechniques: [], relatedEventIds: [], relatedIocIds: [], contradictingEventIds: [], discriminator: "" }];
