...
describe("buildAssetGraph", () => {
    ...
    s.forensicTimeline.push(
      {
        ...
        description: "encryptor executed",
        severity: "Critical",
        mitreTechniques: [],
  ...
  it("extracts account assets (DOMAIN\\user, UPN) but not file-path segments", () => {
    ...
    s.forensicTimeline.push(
      {
        id: "e1",
        timestamp: "",
        description: "logon by ADATUMLAB\\jdoe from 10.0.0.9; file C:\\Users\\srv\\x.exe",
        severity: "High",
        mitreTechniques: [],
        relatedFindingIds: [],
        sourceScreenshots: [],
      ...
      },
      {
        id: "e2",
        timestamp: "",
        description: "token for admin@adatumlab.local observed",
        severity: "Medium",
        mitreTechniques: [],
        relatedFindingIds: [],
        sourceScreenshots: [],
    ...
    s.forensicTimeline.push({
      id: "e3",
      description: "process execution from archive Zip\\7z.exe extracted Mimikatz",
      timestamp: "",
      severity: "High",
      mitreTechniques: [],
      relatedFindingIds: [],
    ...
    s.forensicTimeline.push({
      id: "e4",
      description: "logon by CORP\\first.last succeeded",
      timestamp: "",
      severity: "Low",
      mitreTechniques: [],
      relatedFindingIds: [],
  ...
  it("links an IP IoC referenced only in the description, with boundary-aware matching", () => {
    ...
    s.forensicTimeline.push(
      // i1 appears ONLY in free text (no structured field, no finding) → must still link.
      {
        id: "e1",
        timestamp: "",
        description: "outbound beacon to 192.168.1.1 observed",
        severity: "High",
        mitreTechniques: [],
        relatedFindingIds: [],
        sourceScreenshots: [],
      ...
      // Mentions 192.168.1.10 / 11.1.1.10 only — must NOT link i1 (192.168.1.1) or i2 (1.1.1.1).
      {
        id: "e2",
        timestamp: "",
        description: "scan from 192.168.1.10 and 11.1.1.10",
        severity: "High",
        mitreTechniques: [],
        relatedFindingIds: [],
        sourceScreenshots: [],
  ...
  function seeded() {
    ...
    s.forensicTimeline.push(
      ...
      },
      {
        ...
        description: "beacon to 10.0.0.9",
        severity: "High",
        mitreTechniques: [],
        relatedFindingIds: [],
        sourceScreenshots: [],
