...
## Case folder layout
    ...
    cases/<caseId>/
      ...
      metadata/imports.jsonl              append-only import audit trail (CSV + log + THOR + SIEM/EDR + Chainsaw/EVTX + Hayabusa + Velociraptor + Suricata/Zeek + KAPE/EZ + M365/Entra + AWS CloudTrail + GCP/Azure + Plaso uploads share the same sequence)
      state/
