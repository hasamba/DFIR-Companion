...
| `npm run bench:storage` | Benchmark indexed import, cold open, filtered query, and cursor export at 1M and 10M forensic events. Override with `-- --sizes=100000 --chunk=10000`; `--temp-root=<dir>` selects a filesystem with enough free space. |
