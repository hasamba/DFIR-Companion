...
### Added
- **Story so far in the Now cockpit** — a kill-chain stage chain (first seen, host, click to filter the timeline) plus the two-sentence synthesis conclusion and a stale-since-synthesis tag, derived, no AI (closes #1487)
