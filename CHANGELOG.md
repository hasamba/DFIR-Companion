...
- **Simple / Advanced view in Settings** — Settings opens showing only the 51 controls a feature is dead without (API keys, service URLs, tool binaries) across 7 tabs, instead of 257 fields across 16. Advanced restores the full view and the choice is remembered per browser. Anything with a working default is Advanced.
