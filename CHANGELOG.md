...
### Added
- **Hypothesis-driven investigation mode** — status-tracked investigative hypotheses (open / supported / refuted / unknown) auto-generated on synthesis and analyst-authored, with evidence/technique links, a dashboard panel, a "→ Hypothesis" promote button on notebook entries, and a report section; auto-generated hypotheses refresh on re-synthesis but freeze once the analyst edits them, survive synthesis, and travel in case snapshots (closes #140).
