...
### Added
- **`DFIR_ALLOWED_HOSTS` / `DFIR_ALLOWED_HOST_SUFFIXES`** — name the hostnames a proxied or hosted deployment answers to. Railway auto-detects its own; the Killercoda tutorial trusts its session domain by suffix.
