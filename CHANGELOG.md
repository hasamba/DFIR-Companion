...
- **Persistent hunt suggestions** — generated playbook hunts now survive a page refresh (`state/playbook-hunts.json`); a suggestion is kept only while its task is unchanged and dropped once the task is reworded or deleted (#70).
